  ...
  return (
    <div className='max-w-[100%]'>
      ...
      <div className="flex flex-col justify-center items-center bg-slate-200">
        ...
        <div className="max-w-[100%] mx-auto grid items-center justify-between"></div>
        <div>
      ...
      <button className='bg-[#3eb6ed] w-[200px] float-left rounded-md font-medium py-2 text-black'>Edit Product</button>

      <button className='bg-[#ed3e3e] w-[200px] float-right rounded-md font-medium py-2 text-black' onClick={handleDelete}>Delete Product</button>
