...
const Design = () => {
  return (
    ...
    <div className='max-w-[100%] mx-auto grid md:grid-cols-2'>
      <img className='w-[500px] rounded-3xl mx-auto my-4' src='https://res-console.cloudinary.com/ddei3mzex/thumbnails/v1/image/upload/v1709420120/VG9tb3Jyb3dfd2VfZmliZ2h0X19fSW5zdGFncmFtX3NucmhrcA==/as_is' alt='imagery'/>
